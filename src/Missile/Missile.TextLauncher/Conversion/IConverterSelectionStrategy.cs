...
namespace Missile.TextLauncher.Conversion
{
    ...
    public interface IConverterSelectionStrategy
    {
        ...
        /// <param name="source">Conversion source type (e.g. if you have an IObservable<string> then source would be string</param>
        /// <param name="dest">Conversion destination type (e.g. if you have an IObservable<string> then dest would be string</param>
