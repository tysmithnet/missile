...
namespace Missile.TextLauncher.Interpretation.Lexing
{
    ...
    internal class ErrorState : State
    {
        ...
        /// </summary>
        /// <exception cref="T:System.InvalidOperationException">ErrorState cannot be flushed</exception>
        public override void Flush()
        {
            throw new InvalidOperationException("ErrorState cannot be flushed");
        }
